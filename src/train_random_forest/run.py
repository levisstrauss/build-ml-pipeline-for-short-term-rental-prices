...
def go(args):
    ...
    trainval_local_path = run.use_artifact(args.trainval_artifact).file() # Get the trainable model
    ######################################
    ...
    artifact = wandb.Artifact(
        ...
        type="model_export",
        description="Exporting RandomForest artifact in MLFlow sklearn format",
        metadata=rf_config,
    )
